...
//    }
    ...
    for (auto n = A; n <= N; ++n) {
        ...
        output <<
               ...
               "      <div>"
               "        <input type='checkbox' id='checkbox-auto' name='auto' checked><label for='checkbox-auto'>automorphisms</label>\n"
               "        <input type='checkbox' id='checkbox-coset' name='coset' checked><label for='checkbox-coset'>proper coset preserving</label>\n"
